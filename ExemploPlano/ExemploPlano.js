class ExemploPlano extends JS_CG_2D_API {
  ...
  cliqueDoMouse(e) {
    // Converte a posição do canvas (com origem no canto superior esquerdo) para o centro (0,0)
    const x = Math.floor(e.x - this.larguraTela() / 2);
    const y = Math.floor(e.y - this.alturaTela() / 2);
...
window.addEventListener("load", () => {
  new ExemploPlano("O Plano Cartesiano", "gameCanvas", 600, 600);
});
